...
Create table tienda_bd (
    ...
    Tien_Tipo varchar(100) not null,
...
Create table permiso_bd (
    Perm_clave serial,
    Perm_accion varchar(100) NOT NULL,
...
Create table permiso_rol (
    ...
    constraint cf_perm_rol_permiso foreign key(cf_perm_rol_permiso) references permiso_bd(perm_clave),
    constraint cf_perm_rol_rol foreign key(cf_perm_rol_rol) references rol_bd(rol_codigo)
);
...
CREATE TABLE oferta_bd (
    ofer_porcentaje numeric(100, 50) NOT NULL,
...
CREATE TABLE natural_bd (
    natu_rif numeric,
    natu_correo varchar(100),
    natu_cedula numeric(50) NOT NULL,
    natu_nombre1 varchar(100) NOT NULL,
    natu_nombre2 varchar(100),
    natu_apellido1 varchar(100) NOT NULL,
    natu_apellido2 varchar(100),
...
CREATE TABLE juridico_bd (
    ...
    juri_capital numeric(100, 50) NOT NULL,
...
Create table carnet_bd(
    ...
    cf_carn_tienda_cliente integer,
...
Create table empleado_bd(
    empl_ci numeric,
    empl_nombre1 varchar(100) NOT NULL,
    empl_nombre2 varchar(100),
    empl_apellido1 varchar(100) NOT NULL,
    empl_apellido2 varchar(100),
...
CREATE TABLE empleado_horario (
    ...
    cf_empl_hora_horario varchar (100) NOT NULL,
...
Create table cliente_punto(
    ...
    clie_punt_cantidad numeric(100),
    Cf_clie_punt_punto varchar(100),
...
CREATE TABLE presupuesto_bd (
    ...
    cf_pres_usuario varchar(100) NOT NULL,
...
CREATE TABLE tarjeta_bd (
    tarj_codigo serial,
    tarj_numero varchar(100) NOT NULL,
...
CREATE TABLE cheque_bd (
    cheq_codigo serial,
    cheq_numero varchar(100) NOT NULL,
    cf_cheq_banco integer,
...
CREATE TABLE presupuesto_producto_bd (
    ...
    cf_pre_pro_presupuesto varchar(100) NOT NULL,
...
Create table pago_bd(
    Pago_codigo serial,
    Pago_monto numeric(100, 50),
    Cf_pago_compra integer,
    Cf_pago_punto varchar(100),
    ...
    Constraint cf_pago_punto foreign key(cf_pago_punto) references punto_bd(punt_clave)
);

CREATE TABLE ordenreposicion_bd (
    orde_clave varchar(100),
    orde_descripcion varchar(100) NOT NULL,
...
CREATE TABLE Orden_producto (
    ...
    Cf_Orde_proc_ordenreposicion varchar(100) NOT NULL,
...
CREATE TABLE mediospago (
    ...
    Constraint cf_clie_medi_efecivo foreign key(cf_clie_medi_efecivo) references efectivo_bd(efec_codigo)
);